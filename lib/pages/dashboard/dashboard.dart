...
class _DashboardState extends State<Dashboard>
  ...
  void initState() {
    ...
    setState(() {
      greatestValue = graphData.reduce((value, element) => value > element ? value : element);
      print(greatestValue);
                      ...
                      children: [
                        ...
                        SizedBox(width: double.infinity,
                          child: Stack(alignment: Alignment.center,
                            children: [
                              Image.asset("lib/pages/dashboard/assets/bg.png",
                              fit: BoxFit.fill,),
                              Image.asset("lib/pages/dashboard/assets/line.png",
                              fit: BoxFit.fill,),
                                  ...
                                  child: SizedBox(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.start,
                                      children: [
                                        ...
                                        Center(
                                          child: Image.asset("lib/pages/dashboard/assets/teeth.png",
                                            fit: BoxFit.fill,
                                        ...
                                        Center(
                                          child: Stack(alignment: Alignment.center,
                                            children: [
                                              Image.asset("lib/pages/dashboard/assets/refresh-bg.png",
                                                fit: BoxFit.fill,
                                                height: MediaQuery.of(context).size.width * 0.2,),
                                              Image.asset("lib/pages/dashboard/assets/refresh.png",
                                                fit: BoxFit.fill,
                                                height: 34, width: 34,),
                                            ],
                                          ),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Image.asset("lib/pages/dashboard/assets/calender.png",
                                        height: 20, width: 20,),
                                ...
                                child: Stack(
                                  children: [
                                    SimpleShadow(
                                      ...
                                      color: HexColor("#E1EAF1"),   // Default: Black
                                      offset: const Offset(5, 5), // Default: Offset(2, 2)
                                      sigma: 5,
                                      child: Image.asset('lib/pages/dashboard/assets/shape1.png'),),
                                    SimpleShadow(
                                      opacity: 1,         // Default: 0.5
                                      color: HexColor("#FFFFFF"),   // Default: Black
                                      offset: const Offset(-5, -5), // Default: Offset(2, 2)
                                      sigma: 5,
                                      child: Image.asset('lib/pages/dashboard/assets/shape1.png'),),
                                    Padding(
                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Container(
                                            ...
                                            child: Image.asset('lib/pages/dashboard/assets/schedule.png',
                                          width: 18, height: 18,)),
                                ...
                                child: Stack(alignment: Alignment.center,
                                  children: [
                                    SimpleShadow(
                                      ...
                                      offset: const Offset(5, 5), // Default: Offset(2, 2)
                                      sigma: 5,
                                      child: Image.asset('lib/pages/dashboard/assets/shape2.png'),             // Default: 2
                                                        ),
                                    SimpleShadow(
                                      opacity: 1,         // Default: 0.5
                                      color: HexColor("#FFFFFF"),   // Default: Black
                                      offset: const Offset(-5, -5), // Default: Offset(2, 2)
                                      sigma: 5,
                                      child: Image.asset('lib/pages/dashboard/assets/shape2.png'),),
                                    Padding(
                                      padding: const EdgeInsets.all(9.0),
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: Image.asset('lib/pages/dashboard/assets/consultation.png',
                                          width: 18, height: 18,)),
                                        ],
                                      ),
                                    ),
                                ...
                                child: Stack(
                                  children: [
                                    SimpleShadow(
                                      ...
                                      offset: const Offset(5, 5), // Default: Offset(2, 2)
                                      sigma: 5,
                                      child: Image.asset('lib/pages/dashboard/assets/shape3.png'),),
                                    SimpleShadow(
                                      opacity: 1,         // Default: 0.5
                                      color: HexColor("#FFFFFF"),   // Default: Black
                                      offset: const Offset(-5, -5), // Default: Offset(2, 2)
                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.end,
                                        children: [
                                          Container(
                                            ...
                                            child: Image.asset('lib/pages/dashboard/assets/specialization.png',
                                          width: 18, height: 18,)),
                                          SizedBox(height: MediaQuery.of(context).size.height * 0.008,),
                                          if(isCollapsed)
                                          Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(fit: BoxFit.fill,
                                image: AssetImage("lib/pages/dashboard/assets/card-bg.png"))
                            ),
                            child: Padding(
                              padding: const EdgeInsets.all(16.0),
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      colors: [HexColor(lightColor1), HexColor(lightColor2)]),
                                      const SizedBox(height: 8,),
                                      Text("Patient name",
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Stack(alignment: Alignment.bottomCenter,
                                        children: [
                                          Padding(
                                            ...
                                            child: Image.asset("lib/pages/dashboard/assets/img2.png",
                                            height: 90, width: 100,),
                                          ),
                                          Positioned(bottom: 0,
                                            child: Container(
                                      ...
                                      Container(
                                        ...
                                        child: Center(
                                          child: Image.asset("lib/pages/dashboard/assets/arrow.png",
                                          height: 19, width: 19,),
                                        ),
                                      )
                                    ],
                                            ...
                                            children: [
                                              for(int i = 0; i < 8; i++)
                                                Padding(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    color: HexColor("#F4F4F7").withOpacity(.5),
                        ...
                        Container(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              padding: const EdgeInsets.all(10),
                                                ...
                                                child: Image.asset("lib/pages/dashboard/assets/insights.png")),
                                              ...
                                              Stack(//crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  ...
                                                  Positioned(bottom: 0,
                                                      child: Text("Doctors Patient Data Summary",
                                                    style: CustomFonts.slussen10W500(
                                              ...
                                              children: [
                                                for(int i = 0; i < graphData.length; i++)
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.end,
                                                    children: [
                                                      Image.asset("lib/pages/dashboard/assets/graph-candle.png",
                                                      fit: BoxFit.fill,
                                                      width: 37, height: graphData[i]/total * 500,),
                                                      const SizedBox(height: 8,),
                                                      Text(days[i],
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                      ...
                                      children: [
                                        TextSpan(text: "Patient Love! ",
                                        style: CustomFonts.slussen12W700(
                                          color: Colors.white
                                        )),
                                        const TextSpan(text: "Patient love! Your ratings surged "),
                                        TextSpan(text: "20% ",
                                        style: CustomFonts.slussen12W700(
                                          color: HexColor(goldLightColor)
                                        )),
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          Image.asset("lib/pages/dashboard/assets/share.png",
                                          height: 12, width: 12,),
                                          const SizedBox(width: 3,),
                                          Text("Share Progress",
                                          style: CustomFonts.slussen10W500(
                              ...
                              Stack(alignment: Alignment.bottomCenter,
                                children: [
                                  Image.asset("lib/pages/dashboard/assets/photo.png",
                                  fit: BoxFit.fill,),
                                      ...
                                      children: [
                                        Column(crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            ...
                                            padding: const EdgeInsets.all(12),
                                              child: Center(
                                                child: Image.asset("lib/pages/dashboard/assets/chat.png",
                                                height: 30, width: 30,),
                                              ),
                                            ),
                                            const SizedBox(height: 8,),
                                        ...
                                        Column(crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            ...
                                            padding: const EdgeInsets.all(12),
                                              child: Center(
                                                child: Image.asset("lib/pages/dashboard/assets/faq.png",
                                                height: 30, width: 30,),
                                              ),
                                            ),
                                            const SizedBox(height: 8,),
                                        ...
                                        Column(crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            ...
                                            padding: const EdgeInsets.all(12),
                                              child: Center(
                                                child: Image.asset("lib/pages/dashboard/assets/mail.png",
                                                height: 30, width: 30,),
                                              ),
                                            ),
                                            const SizedBox(height: 8,),
