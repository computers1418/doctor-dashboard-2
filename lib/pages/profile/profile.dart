                      ...
                      children: [
                        ...
                        SizedBox(width: double.infinity,
                          child: Stack(alignment: Alignment.bottomCenter,
                            children: [
                              Image.asset("lib/pages/profile/assets/bg.png",
                              fit: BoxFit.fill,
                              // color: HexColor(primaryColor),
                              ),
                              Positioned(bottom: screenWidth * 0.04,
                                child: Image.asset("lib/pages/profile/assets/img1.png",
                                      fit: BoxFit.fill,
                                ...
                                child: Stack(
                                  children: [
                                    SimpleShadow(
                                      ...
                                      sigma: 5,
                                      child: Image.asset('lib/pages/profile/assets/card.png'),),
                                    SimpleShadow(
                                      opacity: 1,         // Default: 0.5
